<template>
  <el-menu :default-active="index" class="no-border" mode="horizontal" router collapse-transition text-color="#303133"
    ...
    <el-menu-item v-show="showItems.showTeamPageList" index="/home/teamPageList">
    ...
    <!--<el-menu-item v-show="showItems.showMore" index="">-->
      <el-submenu v-show="showItems.showMore" index="">
        <template slot="title">
          <span class="font-style">···</span>
        </template>
        <el-menu-item v-show="!showItems.showTeamPageList" index="/home/teamPageLis">竞赛团队</el-menu-item>
        <el-menu-item v-show="!showItems.showForum" index="/home/forum">论坛</el-menu-item>
        <el-menu-item v-show="isLogin && !showItems.showAddTeam" index="/home/addTeam">创建团队</el-menu-item>
        <el-menu-item v-if="isAdmin == 'admin' && !showItems.showAduit" index="/home/auditTeamPageList">审核</el-menu-item>
        <el-menu-item v-if="isAdmin == 'admin' && !showItems.showUserAdmin" index="/home/userManagement">用户管理</el-menu-item>
      </el-submenu>
